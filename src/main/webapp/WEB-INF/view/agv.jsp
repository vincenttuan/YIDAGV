            ...
            function update(data){  // 更新資料
                ...
                for(let i=0;i<data.tasks.length;i++){
                    ...
                    task_body_html += 
                            ...
                            "<td><button type=\"button\" class=\"btn btnt\" onclick=\"removeTaskById('"+data.tasks[i].id+"')\">"+
                            "<svg xmlns=\"${pageContext.request.contextPath}/image/trash.svg\" width=\"16\" height=\"16\" fill=\"white\" class=\"bi bi-trash\" viewBox=\"0 0 16 16\">"+
